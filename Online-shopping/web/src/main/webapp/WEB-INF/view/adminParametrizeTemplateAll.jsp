                ...
                <div class="navbar-collapse collapse">
                    <ul class="nav navbar-nav">
                        <li>
	  					...
	  					<sec:authorize access="hasRole('admin')">
							<li class="active"><a href="parametrizeTemplateStep0">Parametrize template</a></li>
	  					</sec:authorize>
<%-- 	  		            <sec:authorize access="hasRole('admin')">
				...
				<div id="layer1">
					<table>
						<tr>
							...
							<td width="250"></td>
							<td>
							<form action="parametrizeTemplateStep1?" method="GET">
									<select name="categoryId" id="categoryId"
										onchange="this.form.submit()">
										<c:forEach items="${requestScope.productCategory2}" var="category2">
					                     	<option   <c:out value="${category2.selectedItem}"></c:out>   value="<c:out value="${category2.categoryId}"></c:out>"><c:out value="${category2.categoryName}"></c:out></option>
		                            	</c:forEach>
									</select>
								</form>
							</td>
