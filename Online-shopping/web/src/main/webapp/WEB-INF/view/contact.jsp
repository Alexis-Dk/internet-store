...
<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBpGJICJ-vMT8y_ImIeNDQvbbbOXcp5WAQ&v=3.exp&sensor=false"
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="product-bit-title text-center">
                        <h2><locale:message code="label.ContactUs"/></h2>
                    </div>
                </div>
            </div>
        </div>
								...
								<section class="container">
									<div class="container-page">
										...
										<div class="col-md-6">
											...
											<h3 class="dark-grey"><locale:message code="label.AdressParameter1"/></h3>
											<p><locale:message code="label.AdressParameter2"/></p>
											<p><locale:message code="label.AdressParameter3"/></p>
											<p><locale:message code="label.AdressParameter4"/></p>
											<p><locale:message code="label.AdressParameter5"/></p>
										</div>
									</div>
								</section>
							</div>
